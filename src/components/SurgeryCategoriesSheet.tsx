            ...
            return (
              ...
              >
                ...
                <div className="absolute -bottom-3 -right-3 opacity-15 pointer-events-none" aria-hidden>
                  <PhIcon name={phName} size={72} tone="white" weight="fill" />
                </div>
                ...
                <div className="relative flex flex-col gap-2.5 min-h-[108px]">
                  ...
                  >
                    <PhIcon name={phName} size={22} tone="white" weight="duotone" />
                  </motion.div>
                  <div className="mt-auto">
                    <p className="text-white font-bold text-[13px] leading-tight line-clamp-2">{c.label}</p>
